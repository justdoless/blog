import{_ as s}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as a,o as l,c as i,b as n,d as t,e as o,f as c}from"./app-6lnvVoO1.js";const r={},p=c(`<h1 id="pyenv管理python" tabindex="-1"><a class="header-anchor" href="#pyenv管理python" aria-hidden="true">#</a> pyenv管理python</h1><blockquote><p>通过 pyenv 管理 python 版本</p></blockquote><h2 id="_1-通过-homebrew-安装-pyenv" tabindex="-1"><a class="header-anchor" href="#_1-通过-homebrew-安装-pyenv" aria-hidden="true">#</a> 1. 通过 homebrew 安装 pyenv</h2><blockquote><p>如果没有安装 <code>xcode-select</code> 需要先运行 <code>xcode-select --install</code></p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>brew update 
brew <span class="token function">install</span> pyenv
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-修改-zsh-profile" tabindex="-1"><a class="header-anchor" href="#_2-修改-zsh-profile" aria-hidden="true">#</a> 2. 修改 zsh profile</h2><blockquote><p>否则通过pyenv切换python版本会不生效</p></blockquote><ul><li>编辑 .zshrc</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">vim</span> ~/.zshrc 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul><li>在配置下面增加</li></ul><blockquote><p>具体以官方文档的最新要求为准</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">echo</span> <span class="token string">&#39;export PYENV_ROOT=&quot;$HOME/.pyenv&quot;&#39;</span> <span class="token operator">&gt;&gt;</span> ~/.zshrc
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_3-pyenv-常用命令" tabindex="-1"><a class="header-anchor" href="#_3-pyenv-常用命令" aria-hidden="true">#</a> 3. pyenv 常用命令</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 查看 pyenv 已经管理了哪些 python 版本 </span>
pyenv versions 
    system 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-参考" tabindex="-1"><a class="header-anchor" href="#_4-参考" aria-hidden="true">#</a> 4. 参考</h2>`,17),d={href:"https://github.com/pyenv/pyenv#set-up-your-shell-environment-for-pyenv",target:"_blank",rel:"noopener noreferrer"};function u(v,h){const e=a("ExternalLinkIcon");return l(),i("div",null,[p,n("ul",null,[n("li",null,[n("a",d,[t("https://github.com/pyenv/pyenv#set-up-your-shell-environment-for-pyenv"),o(e)])])])])}const k=s(r,[["render",u],["__file","pyenv.html.vue"]]);export{k as default};
