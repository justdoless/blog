import{_ as a}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as o,o as r,c as l,b as n,d as e,e as t,f as s}from"./app-6vu-uFCy.js";const c={},u=s(`<h1 id="samesite-跨站" tabindex="-1"><a class="header-anchor" href="#samesite-跨站" aria-hidden="true">#</a> SameSite（跨站）</h1><p>现代浏览器针对 Cookie 的 <code>SameSite</code> 属性的默认值已经很合理了，作为网站所有者通常不需要手动设置这个属性，一般只有当我们的服务需要和“第三方”对接时才考虑怎么设置更合理。</p><p><code>Strict</code> 最为严格，表示完全禁止“第三方 Cookie”，只有当前网页的 URL 与请求目标一致时，才会带上 Cookie，一般用于保证系统的封闭性和安全性。</p><p><code>Lax</code> 是目前大多数现代浏览器的默认值，他在保证安全性的前提下，也可以避免一些不好的用户体验，比如从别的网站跳转过时会没有登录态。</p><p><code>None</code> 是最为宽松的一种设定，通常用于开放我们的服务给不同的第三方接入，同时又需要追踪用户的场景，比如广告，设置为 <code>None</code> 时需要考虑开放的安全性。</p><blockquote><p>什么是跨站</p><p>和跨域的区别</p></blockquote><h2 id="_1-cookie-简介" tabindex="-1"><a class="header-anchor" href="#_1-cookie-简介" aria-hidden="true">#</a> 1. Cookie 简介</h2><p>HTTP 协议是<strong>无状态</strong>的，但可以通过 Cookie 来维持客户端与服务端之间的“会话状态”。</p><p>简单来说就是：服务端通过 <strong>Set-Cookie</strong> 响应头设置 Cookie 到客户端，而客户端在下次向服务器发送请求时添加名为 <strong>Cookie</strong> 的请求头，以携带服务端之前“埋下”的内容，从而使得服务端可以识别客户端的身份。</p><p>举个简单的🌰：</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 服务端</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-2-嵌套第三方-iframe" tabindex="-1"><a class="header-anchor" href="#_2-2-嵌套第三方-iframe" aria-hidden="true">#</a> 2.2. 嵌套第三方 iframe</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>const https = require(&quot;https&quot;);
const fs = require(&quot;fs&quot;);
