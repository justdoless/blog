...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_1-3-验证安装" tabindex="-1"><a class="header-anchor" href="#_1-3-验证安装" aria-hidden="true">#</a> 1.3. 验证安装</h3><p>连接到MongoDB数据库服务器并打印版本号：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// mongod -h
mongod -h
