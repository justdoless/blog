import{_ as i}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o as t,c as r,d as s,e as a,b as o,f as n}from"./app-25c1c93f.js";const c={},p=n(`<h1 id="服务进程自启动管理" tabindex="-1"><a class="header-anchor" href="#服务进程自启动管理" aria-hidden="true">#</a> 服务进程自启动管理</h1><blockquote><p>使用系统自带的 systemctl 命令管理服务。</p></blockquote><h2 id="_1-systemctl" tabindex="-1"><a class="header-anchor" href="#_1-systemctl" aria-hidden="true">#</a> 1. systemctl</h2><ul><li>service配置文件 <ul><li>具体路径参考最新的配置要求: <code>/usr/lib/systemd/system/nodejs.service</code></li></ul></li><li>nodejs.service 文件权限设置777可执行权限</li></ul><h3 id="_1-1-常用命令" tabindex="-1"><a class="header-anchor" href="#_1-1-常用命令" aria-hidden="true">#</a> 1.1. 常用命令</h3><ul><li>systemctl daemon-reload 重置配置文件</li><li>systemctl start nodejs.service 启动服务</li><li>systemctl restart nodejs.service 启动服务</li><li>systemctl status nodejs.service 查看服务状态</li><li>systemctl enable nodejs.service 开机自启动服务</li></ul><h2 id="_2-nodejs" tabindex="-1"><a class="header-anchor" href="#_2-nodejs" aria-hidden="true">#</a> 2. nodejs</h2><blockquote><p>nodejs.service 配置参考</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>Unit<span class="token punctuation">]</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-frp自启动服务" tabindex="-1"><a class="header-anchor" href="#_3-frp自启动服务" aria-hidden="true">#</a> 3. frp自启动服务</h2><ul><li>frps.service</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>Unit<span class="token punctuation">]</span>
